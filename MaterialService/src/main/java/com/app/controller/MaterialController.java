...
public class MaterialController {
	...
	public ResponseEntity<List<MaterialCategoryBean>> getMaterialCategories() {	
		List<MaterialCategoryBean> mCbeans=materialService.getMaterialCategories();
		return new ResponseEntity<List<MaterialCategoryBean>>(mCbeans,HttpStatus.OK);
	}
	...
	public ResponseEntity<MaterialCategoryBean> getMaterialCategoryById(@PathVariable String categoryId) {
		MaterialCategoryBean mCbean=materialService.getMaterialCategoryById(categoryId);
		return new ResponseEntity<MaterialCategoryBean> (mCbean,HttpStatus.OK);	
	}
}
